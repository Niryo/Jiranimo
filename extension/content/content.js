...
(function () {
  ...
  function showAboutOverlay() {
    ...
    modal.innerHTML = `
      ...
      <div class="jiranimo-about-body">
        <p>Jiranimo connects your Jira sprint board to Claude Code, letting you dispatch implementation tasks to AI with a single click.</p>
        <div class="jiranimo-about-section">
          <h3>How to use</h3>
          <ul>
            <li>Click the <strong>&#10024;</strong> sparkle icon next to any issue key to send it to Claude Code</li>
            <li>Claude will create a branch, implement the task, and open a draft PR</li>
            <li>The icon turns green when a PR is ready — click to open it</li>
          </ul>
        </div>
        <div class="jiranimo-about-section">
          <h3>Keyboard shortcuts</h3>
          <ul>
            <li><kbd>&#8984; E</kbd> — Show this about page</li>
          </ul>
        </div>
        <div class="jiranimo-about-section jiranimo-about-status">
          <h3>Server</h3>
          <p>Connected to <code>${serverUrl}</code></p>
        </div>
      </div>
